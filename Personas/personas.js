...
//con lo que sigue mostramos el contacto del primero
...
<div class="card">
  ...
  <div class="container">
    <h4><b>${personas[0].name}</b></h4>
    <p>${personas[0].age}</p>//podemos poner el primero, o el segundo o el que sea segun el número que se ponga entre []
    <p>${personas[0].email}</p>
    <p>${personas[0].address}</p>
  </div>
</div>`;
